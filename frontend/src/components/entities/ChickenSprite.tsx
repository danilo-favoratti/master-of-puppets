...
import {
  AnimalChickenConfType,
  getRandomChicken,
} from "../../types/animal-chicken";
...
export const ChickenSprite = ({
  ...
  const [body, setBody] = useState<AnimalChickenConfType>(getRandomChicken());
